...
void loop() {
    ...
    randomAngle = random(0, 181); // random(A,B); returns a random value between A and B
    randomDelay = random(500, 2501); // returns a random pulse width between 500 and 2500
